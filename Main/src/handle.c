...
void getHandleADC()
{
	master.handle.tilt = getChannelHandleADC(8);
	master.handle.run = 4096 - getChannelHandleADC(9);
	master.handle.turn = getChannelHandleADC(10);
	master.handle.height = 4096 - getChannelHandleADC(11);
}
